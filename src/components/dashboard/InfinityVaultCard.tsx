...
const renderEnergyBeam = (
  ...
  return (
    <div className="flex flex-col items-end gap-0.5 sm:gap-1 w-20 sm:w-22 xl:w-28 shrink-0">
      {/* Top Metric Header: Percent */}
      <div className="flex items-center justify-end w-full text-[9px] sm:text-[10px] xl:text-[11px] font-display font-bold tracking-wider leading-none">
