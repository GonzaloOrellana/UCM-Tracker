...
export const DoomsdayBentoCard: React.FC<DoomsdayBentoCardProps> = ({ onNavigate }) => {
  return (
    ...
    >
      <div className="relative tactile-bento-card rounded-2xl sm:rounded-3xl p-3.5 sm:p-4.5 lg:p-4 xl:p-5 flex flex-col justify-between h-[180px] sm:h-[195px] lg:h-full overflow-hidden border-emerald-500/30 hover:border-emerald-400/60 hover:shadow-[0_0_28px_rgba(16,185,129,0.22)] transition-all duration-500 bg-gradient-to-br from-[#07130F]/90 via-[#0B0D18]/90 to-[#120817]/90">
        ...
        <div className="relative z-10 my-auto py-1 sm:py-2">
          <h3 className="font-display text-sm sm:text-base lg:text-lg xl:text-2xl font-bold tracking-tight text-white leading-tight group-hover/doomsday:text-emerald-300 transition-colors drop-shadow-[0_2px_8px_rgba(0,0,0,0.9)] line-clamp-2">
            Camino a Doomsday & Secret Wars
          </h3>
          <p className="text-[11px] lg:text-[11.5px] xl:text-[12px] text-zinc-300/80 mt-1 sm:mt-1.5 leading-relaxed font-sans max-w-sm line-clamp-2">
