...
export const DashboardView: React.FC<DashboardViewProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="h-full flex-1 min-h-0 flex flex-col justify-between gap-2.5 lg:gap-3 xl:gap-3.5 animate-fade-in relative pb-10 lg:pb-0 select-none">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-2.5 lg:gap-3 xl:gap-3.5 shrink-0 [@media(min-width:1024px)_and_(min-height:820px)]:h-[43%] min-h-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-2.5 lg:gap-3 xl:gap-3.5 flex-1 min-h-0">
